const Card = () => {
  return (
    <div id="card" className=" flex flex-col md:flex-row md:gap-5 justify-center items-center padding-section">
      <div className=" flex flex-col items-center font-Playfair mb-12 bg-gradient-to-r from-[#4E4FEB] via-[#EEEEEE] to-[#068FFF] text-transparent bg-clip-text">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-6xl mb-5">It's a Way of Life</h2>
